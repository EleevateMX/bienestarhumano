...
- 🔐 **Login con 2 usuarios** (Alejandra y Chucho)
- 🎨 **Logo oficial** de la Dirección integrado (`logo.png` + `logo-icon.png` + `logo-white.png`)
...
├── logo-icon.png            → Logo solo ícono
├── logo-white.png           → Logo blanco para la pantalla de carga
└── README.md                → Esta guía
```
...
2. Arrastra los **8 archivos** del proyecto:
   ...
   - `logo-white.png` ⬅️ **importante: logo blanco para la carga azul**
   - `README.md`
...
| Logo                         | Reemplaza `logo.png`, `logo-icon.png` y `logo-white.png`    |
